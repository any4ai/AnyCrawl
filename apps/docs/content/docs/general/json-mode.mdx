...
Important: include `"json"` in `formats` when using `json_options`, otherwise the response will not contain extracted JSON data.
...
- [Scrape API](./scrape) - Basic scraping with JSON extraction
- [Crawl API](./crawl) - Crawling with JSON extraction options
- [Template System](./template) - Advanced data extraction templates
